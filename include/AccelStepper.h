...
/// from http://www.airspayce.com/mikem/arduino/AccelStepper/AccelStepper-1.66.zip
///
...
/// \par Copyright
///
/// This software is Copyright (C) 2009-2023 Mike McCauley. Use is subject to license
...
///                largely oriented to implementing new step-scheduling algorithms.<br>
/// \Version 1.65 2025-04-25
///                Updated Copyrights.<br>
///                Added setAccelerationRoot() from Jonathan Newbrough
///                for performance improvements if you have some sqare roots cached.<br>
///                Converted all examples from .pde to .ino.<br>
/// \Version 1.66 2026-01-21
///                Fixed an issue with moving to negative positions with 3 wire Half Step, patched by Richard Hulme.<br>
///
...
public:
    ...
    /// Sets the acceleration/deceleration rate, using the square root of the required acceleration.
    /// This can be useful if you precompute square roots of required accelerations, which can yield performance
    /// improvements if you frequently change ccelerations. Contributed by 
    /// \param[in] sqrtAcceleration The square root of the required acceleration in steps per second.
    ///  Must be > 0.0. Dont call more ofthen than needed.
...
/// @example Overshoot.ino
///  Check overshoot handling
/// which sets a new target position and then waits until the stepper has 
/// achieved it. This is used for testing the handling of overshoots
 
/// @example MultipleSteppers.ino
/// Shows how to multiple simultaneous steppers
/// Runs one stepper forwards and backwards, accelerating and decelerating
/// at the limits. Runs other steppers at the same time
 
/// @example ConstantSpeed.ino
/// Shows how to run AccelStepper in the simplest,
/// fixed speed mode with no accelerations
 
/// @example Blocking.ino 
/// Shows how to use the blocking call runToNewPosition
/// Which sets a new target position and then waits until the stepper has 
/// achieved it.
 
/// @example AFMotor_MultiStepper.ino
/// Control both Stepper motors at the same time with different speeds
/// and accelerations. 
 
/// @example AFMotor_ConstantSpeed.ino
/// Shows how to run AccelStepper in the simplest,
/// fixed speed mode with no accelerations
 
/// @example ProportionalControl.ino
...
/// @example Quickstop.ino
/// Check stop handling.
/// Calls stop() while the stepper is travelling at full speed, causing
/// the stepper to stop as quickly as possible, within the constraints of the
/// current acceleration.
 
/// @example MotorShield.ino
